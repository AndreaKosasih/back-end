...
<head>
    ...
    <!-- Link ke CSS Framework seperti TailwindCSS -->
    <link href="https://cdn.jsdelivr.net/npm/tailwindcss@2.2.19/dist/tailwind.min.css" rel="stylesheet">
    <!-- Jika menggunakan font tertentu -->
    <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;700&display=swap" rel="stylesheet">

    <!-- Favicon -->
    <link rel="icon" href="/path/to/favicon.ico">
    
    <!-- Optionally include any custom CSS -->
    <link rel="stylesheet" href="<?= base_url('assets/css/style.css'); ?>">

    <!-- Jika Anda menggunakan JS libraries -->
    <script src="https://cdn.jsdelivr.net/npm/vue@2.6.14/dist/vue.min.js"></script>

    <!-- Any other head elements such as meta tags or external stylesheets -->
</head>
    ...
    <div class="container mx-auto py-6">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">Product Transactions</h2>

                <!-- Menampilkan transaksi -->
                <?php foreach ($transactions as $transaction): ?>
                <div class="item-card flex flex-row justify-between items-center border-b py-4">
                    ...
                    <div>
                        ...
                        <h3 class="text-indigo-950 text-xl font-bold">Rp <?= 'Rp ' . number_format($transaction->total_amount, 0, ',', '.') ?></h3>
                    ...
                    <div class="hidden md:flex flex-row items-center gap-x-3">
                        <a href="<?= site_url('admin/transactions/show/' . $transaction->id) ?>" class="font-bold py-4 px-6 bg-indigo-700 text-white rounded-full">
                            View Details
                        </a>
                    </div>
                </div>
